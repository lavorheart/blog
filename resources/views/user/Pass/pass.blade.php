...
<body>
      ...
      {{csrf_field()}} 
        ...
        <fieldset>
        <legend contenteditable="true">找回通行证密码</legend> 
         @if(session('info'))
         ...
         @endif  
          <label contenteditable="true">请填写您需要找回的账号</label> 
            <input value="{{ old('EmailAddress')}}" name="EmailAddress" placeholder="用户名\邮箱\手机号" type="text" /> 
