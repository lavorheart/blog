...
<script type="text/javascript" src="/user/js/index/modernizr.custom.44625.js"></script>
    ...
    <div class="center-block clearfix">
        ...
        <div id="menu" class="fix-fish-menu">
            ...
            <ul id="nav" class="sf-menu">
                ...
                <li class=""><a href="#" class="active">Blog</a>
                    <ul>
...
<div id="wrapper">
    ...
    <div id="separator">
        <div class="center-block">
            <h3>SINGLE POST</h3>
            <span>: This is a custom page description.</span>
        </div>
    </div>
