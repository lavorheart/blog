	...
	if(/chrome/.test(navigator.userAgent.toLowerCase()) && ad_h5 != undefined && ad_h5 != null && ad_h5 != ""){
		if (/\.html$/.test(ad_h5.toLowerCase())) {
			...
			(function(img_ad_h5, img_a_h5, img_w, img_h, img_h5_isActive, img_h5_impression,img_h5_click_imp_arr){
				...
				document.write('<div style="clear:both;position:relative;margin:0 auto;width:' + img_w + 'px;height:' + img_h+ 'px;"><a href="javascript:void(0)" style="width: 35px;height: 15px;overflow: hidden;position: absolute;left: 0;bottom: 0;z-index: 2;background: url(http://y2.ifengimg.com/ifengimcp/pic/20150902/3677f2773fd79f12b079_size1_w35_h15.png) no-repeat;"></a><a id="'+ clickNameId +'" target="_blank" href="' + img_a_h5 + '"><img src="' + img_ad_h5 + '" style="width:' + img_w + 'px;height:' + img_h+ 'px;border:none;"/></a>');		
		...
		if (/\.swf$/.test(ad.toLowerCase())) {	
			...
			if (/\.html$/.test(ad.toLowerCase())) {
				...
				(function(img_ad, img_a, img_w, img_h, img_Active,img_click_imp_arr){
					var clickNameId = "click_a"+Math.ceil(Math.random() * 1000000);
					document.write('<div style="clear:both;position:relative;margin:0 auto;width:' + img_w + 'px;height:' + img_h+ 'px;"><a href="javascript:void(0)" style="width: 35px;height: 15px;overflow: hidden;position: absolute;left: 0;bottom: 0;z-index: 2;background: url(http://y2.ifengimg.com/ifengimcp/pic/20150902/3677f2773fd79f12b079_size1_w35_h15.png) no-repeat;"></a><a id="'+ clickNameId +'" target="_blank" href="' + img_a + '"><img src="' + img_ad + '" style="width:' + img_w + 'px;height:' + img_h+ 'px;border:none;"/></a>');
					document.write('</div><div class="clear"></div>');		
